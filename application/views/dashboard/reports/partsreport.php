...
<div class="container-fluid mt-4">
  ...
  <div class="card filter-section">
    <h5 class="mb-3">Installed Parts Report</h5>
...
<script>
  ...
  createdCell: function(td, cellData, rowData, row, col) {
    ...
    footerCallback: function (row, data, start, end, display) {
        ...
        var total = api
            .column(10, { page: 'current' }) // Column index for 'price'
            .data()
            .reduce(function (a, b) {
        ...
        // Update footer
        $j(api.column(10).footer()).html(total.toFixed(2));
    }
});
...
<style>
    @media print {
        @page {
            margin: 20mm;   /* no size, no orientation */
        }
