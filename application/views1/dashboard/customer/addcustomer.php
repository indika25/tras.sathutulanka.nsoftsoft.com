                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" name="customer_name" class="form-control"
                                    placeholder="Ex: Kamal Jayasinghe" required>
                            </div>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="number" name="mobile" class="form-control" placeholder="EX: 0785092933">
                            </div>
                        ...
                        <input type="text" name="phone" class="form-control" placeholder="">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <textarea name="primary_address" class="form-control"
                        ...
                        success: function(data) {
                            if (data.success) {
                                Swal.fire('Deleted!', data.message ||
                                    'Customer has been deleted.', 'success');
                                table.ajax
                            .reload(); // Reload the table after deletion
                            } else {
